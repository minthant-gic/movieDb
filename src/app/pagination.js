                ...
                <nav className="relative z-0 inline-flex shadow-sm -space-x-px" aria-label="Pagination">
                    <a
                        className={`relative inline-flex items-center px-2 py-2 rounded-l-md border ${
                            currentPage === 1 ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'border-gray-300 bg-white text-gray-500 hover:bg-gray-50'
                    ...
                    <a
                        className={`relative inline-flex items-center px-2 py-2 rounded-r-md border ${
                            currentPage === totalPages ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'border-gray-300 bg-white text-gray-500 hover:bg-gray-50'
                        } text-sm font-medium focus:z-10 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500`}
